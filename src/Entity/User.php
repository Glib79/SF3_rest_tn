...
class User extends BaseUser implements UserInterface, \Serializable
{
     ...
     * @ORM\OneToOne(targetEntity="Client", mappedBy="user", fetch="EAGER")
     */
    protected $oauthClient;
    /**
     * One User has many Access Tokens;
     * @ORM\OneToMany(targetEntity="AccessToken", mappedBy="user", fetch="EAGER")
     */
    protected $accessToken;
    /**
     * One User has many Auth Codes;
     * @ORM\OneToMany(targetEntity="AuthCode", mappedBy="user", fetch="EAGER")
     */
    protected $authCode;
    /**
    * One User has many Refresh Tokens;
    * @ORM\OneToMany(targetEntity="RefreshToken", mappedBy="user", fetch="EAGER")
    */
